...
extern uint8_t scancode_to_ascii[0xff];
extern uint8_t scancode_to_ascii_shift[0xff];
extern uint8_t scancode_to_ascii_capslock[0xff];
extern uint8_t scancode_to_ascii_capslock_shift[0xff];
